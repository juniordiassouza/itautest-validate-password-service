...
import br.com.itautest.models.Erro;
...
public class PasswordController implements RestApiController{
    ...
    @ApiResponse(code= 400, message = "Request error", response = Erro.class),
    @ApiResponse(code= 404, message = "Resource not found", response = Erro.class),
    @ApiResponse(code= 500, message = "Internal error", response = Erro.class)
    })
